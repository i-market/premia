...
<section class="wrap_slider">
    ...
    <div class="slider">
        <div class="slide slide--inner slide--opacity" style="background: url('<?= v::asset('images/upload/slides/homepage-slide-1.jpg') ?>')no-repeat center center">
            <div class="block">
                <h1>Четыре сезона</h1>
        ...
        <div class="slide slide--inner slide--opacity" style="background: url('<?= v::asset('images/upload/slides/homepage-slide-2.jpg') ?>')no-repeat center center">
            <div class="block">
                <h1>Четыре сезона</h1>
                <span class="line"></span>
                <h2>оптово-распределительный центр</h2>
        ...
        <div class="slide slide--inner slide--opacity" style="background: url('<?= v::asset('images/upload/slides/homepage-slide-3.jpg') ?>')no-repeat center center">
            <div class="block">
                <h1>Четыре сезона</h1>
                <span class="line"></span>
...
<section class="advantages_center">
    ...
    <div class="wrap">
        <div class="edited_block">
            ...
            <p>Каждый день мы работаем над тем, чтобы предоставить вам максимально комфортные условия. В своей деятельности мы стремимся к тому, чтобы удовлетворить потребности всех групп покупателей и сделать процесс покупок и сотрудничества с нами максимально удобным.</p>
        </div>
